    ...
    <section className="rounded-xl border bg-card p-5 sm:p-6 text-card-foreground shadow-sm">
      <div className="flex items-center gap-2.5 mb-4">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Preserve documentation and records to support your position
          </p>
        </div>
      </div>
      ...
      <ul className="space-y-2.5">
        {items.map((item, index) => (
          <li
            key={index}
            className="flex items-start gap-3 rounded-lg border border-border/70 bg-muted/20 p-3.5 transition-colors hover:bg-muted/40"
          >
